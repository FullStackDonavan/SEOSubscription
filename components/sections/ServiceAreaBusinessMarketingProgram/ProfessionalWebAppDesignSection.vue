  ...
  <section class="container mx-auto mt-20">
    <GridTwoColumns>
      ...
      <div>
        ...
        >
          <NuxtLink
            to="/house-painting-marketing-program/web-application-design"
...
export default {
  ...
  data() {
    return {
      ...
      IntroText: {
        SubHeading:
          "Elevate Your Business with Expertly Crafted Web App Design Solutions",
        Heading: "Expert Web Application Design",
        description:
