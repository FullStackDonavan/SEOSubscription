  ...
  <section class="container mx-auto mt-20">
    <GridTwoColumns>
      ...
      <div>
        ...
        >
          <NuxtLink
            to="/house-painting-marketing-program/online-review-management-system"
...
export default {
  ...
  data() {
    return {
      ...
      IntroText: {
        SubHeading:
          "Maximize Digital Influence: Precision and Authority at Your Fingertips",
        Heading: "Optimizing Your Reviews: Cutting-Edge Management System",
        description:
